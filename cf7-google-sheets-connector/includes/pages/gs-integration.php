                            ...
                            <div class="inside">
                                ...
                                if (!empty(get_option('gs_verify')) && (get_option('gs_verify') == "invalid-auth")) { ?>
                                    ...
                                    <div class="gsc-msg cf7-free-gsc-permission-error gsc-error pt-10 pb-10 manual-margin">
                                        ...
                                        <?php echo wp_kses_post(__('<p class="fw-400 text-dark"><strong>Google Drive</strong> and <strong>Google Sheets</strong> permissions were not granted during authentication with Google.</p>

                                        <p class="fw-400 text-dark"><strong>Refer to Step 4 in the Connection Guide shown alongside.</strong><br> Then, deactivate the connection and re-authorize it, ensuring both Google Drive and Google Sheets permissions are enabled.</p>', 'cf7-google-sheets-connector')); ?>
                                ...
                                <?php    //resolved - google sheet permission issues - START
        ...
        <div class="gsc-pro-section">
            ...
            <div class="gsc-pro-card">
                ...
                <div class="gsc-pro-headers">
                    ...
                    <p class="mb-0 text-center"><?php echo esc_html__('Connect CF7 to Google Sheets using your own Google Cloud project.

                        Ideal for advanced users who need full API control, custom OAuth setup,

                        and independent credential management.', 'cf7-google-sheets-connector'); ?>
...
<div id="gscf7-confirm-deactive-popup-free" class="gs-popup-overlay d-none">
    ...
    <div class="gs-popup text-center">
        ...
        <p class="gsc-modal-text"><?php echo esc_html__('Are you sure you want to deactivate Google Sheets integration?
            ...
            This will stop syncing your form entries.', 'cf7-google-sheets-connector'); ?>
