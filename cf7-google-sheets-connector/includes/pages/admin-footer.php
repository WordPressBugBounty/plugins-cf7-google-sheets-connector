...
function remove_footer_admin () 
{
    echo '<p id="footer-left" class="alignleft">
		Please rate <strong>CF7 GSheetConnector</strong> <a href="https://wordpress.org/support/plugin/cf7-google-sheets-connector/reviews/" target="_blank" rel="noopener noreferrer">★★★★★</a> on <a href="https://wordpress.org/support/plugin/cf7-google-sheets-connector/reviews/" target="_blank" rel="noopener">WordPress.org</a> to help us spread the word.	</p>';
}
...
<div class="gsheetconnect-footer-promotion">
  ...
  <ul class="wpforms-footer-promotion-links">
    ...
    <li> <a href="https://www.gsheetconnector.com/docs/cf7-gsheetconnector/" target="_blank"><?php echo esc_html( __('Docs', 'gsconnector' ) ); ?></a> </li>
