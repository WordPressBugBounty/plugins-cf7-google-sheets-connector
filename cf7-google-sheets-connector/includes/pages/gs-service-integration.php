   ...
   <div class="api_service_setting_cf7 oauth-method row justify-between shadow-box mt-40 p-30" id="gs-cf7-service-setting">
       ...
       <?php } else { ?>
           ...
           <div class="col-5">
               ...
               <p><?php echo esc_html(__("This guide shows how to share your Google Sheet with the connected service account and grant editor access for seamless synchronization.", 'cf7-google-sheets-connector'));
